...
app.post('/register', async (req, res) => {
    ...
    try {
        ...
        console.error('Error registering user:', error); // เพิ่มรายละเอียดข้อผิดพลาด
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        console.error('Error logging in:', error); // เพิ่มรายละเอียดข้อผิดพลาด
...
app.post('/addnew', async (req, res) => {
    ...
    try {
        ...
        console.error('Error adding new employee:', error); // เพิ่มรายละเอียดข้อผิดพลาด
        res.status(500).send('Error');
    }
});

app.listen(port, () => console.log(`Example app listening on port ${port}!`)); // ใช้ template literals